...
ObstacleAvoidanceScene::ObstacleAvoidanceScene() {
	...
	text->LoadImage("../res/Text/obstacleAvoidance.png");
}
...
void ObstacleAvoidanceScene::update(float dtime, SDL_Event *event) {
...
void ObstacleAvoidanceScene::draw() {
...
const char* ObstacleAvoidanceScene::getTitle() {
	return "SDL Steering Behaviors :: Obstacle Avoidance Demo";
}
